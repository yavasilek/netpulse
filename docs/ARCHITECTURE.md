...
3. Android DownloadManager загружает файл.
4. Проверяются SHA-256, package name, versionCode и сертификат подписи.
5. Android показывает системное подтверждение установки.
